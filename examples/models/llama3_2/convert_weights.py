...
def llama3_2_to_meta(state_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
    """
    ...
    for key, value in state_dict.items():
        new_key = get_mapped_key(key, _LLAMA3_2_SAFETENSORS_TO_META)
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert Llama3_2 safetensors weights to Meta format."
    )
    parser.add_argument(
        "input_dir",
        type=str,
